  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "shadow-[0_0_6px_rgba(0,0,0,0.05),0_2px_6px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.1),inset_0_-1px_0_rgba(0,0,0,0.1)]",
        "dark:shadow-[0_0_8px_rgba(0,0,0,0.1),0_2px_8px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(0,0,0,0.15)]",
        "hover:bg-white/[0.1] hover:border-white/[0.18] hover:shadow-[0_0_12px_rgba(75,102,209,0.15),0_4px_12px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.15)]",
